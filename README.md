...
- During Loop assembly simulation, PUDU now also generates a Markdown manual protocol file named `<protocol_name>_manual_protocol.md` with deck setup, source mapping, reaction mapping, and step-by-step human pipetting instructions.
